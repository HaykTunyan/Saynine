...
function PrivacyPolicy() {
  return (
    <Fragment>
      <Head>
        <title>Privacy Policy | Saynine</title>
        <meta
          name="description"
          content="We value your privacy and excellent experience with us. Our privacy policy applies to the methods and ways our team uses to communicate with you."
        />
      </Head>
      <Container className="shadow-base min-h-screen rounded-3xl pt-4 my-10">
        <h1 className="text-2xl lg:text-4xl text-center font-semibold py-4">
          Privacy Policy
        </h1>
        <div className="w-full h-1 bg-divider" />
        <div className="p-8 ">
          <p>
            Below you can find our Privacy Policy containing some legal goodies
            which help us take good care of our customers, website visitors, and
            partners.
          </p>
          <div className="pt-4 border-0 bg-transparent invisible" />
          <p>
            ...
            the management of the Optify. The use of the Internet pages of the
            Optify is possible without any indication of personal data; however,
            if a data subject wants to use special enterprise services via our
            ...
            subject. The processing of personal data, such as the name, address,
            ...
            applicable to the Optify. By means of this data protection
            ...
            entitled. As the controller, the Optify has implemented numerous
          ...
          <div className="pt-4 border-0 bg-transparent invisible" />
          <h2 className="text-2xl lg:text-3xl font-medium text-center py-4">
            1. Definitions
          </h2>
          <div className="pt-4 border-0 bg-transparent invisible" />
          <p>
            The data protection declaration of the Optify is based on the terms
          ...
          <div className="pt-2 border-0 bg-transparent invisible" />
          <p>
          ...
          <div className="pt-2 border-0 bg-transparent invisible" />
          <p>Optify</p>
          <div className="pt-1 border-0 bg-transparent invisible" />
          <p>Azatutyun Backstreet 4, apt. 5</p>
          <div className="pt-1 border-0 bg-transparent invisible" />
          <p>0037 Yerevan</p>
          <div className="pt-1 border-0 bg-transparent invisible" />
          <p>Armenia</p>
          <div className="pt-1 border-0 bg-transparent invisible" />
          <p>
            Phone: &nbsp;<a href={"tel:+37477939229"}>+37477939229</a>
          </p>

          <div className="pt-1 border-0 bg-transparent invisible" />
          <p>
            Email:&nbsp;
            <a href={"mailto:georgemamajanyan97@gmail.com"}>
          ...
          <p>
            Website:&nbsp;
            <a href={"https://optify.ai"}>optify.ai</a>{" "}
          </p>
          ...
          <div className="pt-4 border-0 bg-transparent invisible" />
          <p>
            The Internet pages of the Optify use cookies. Cookies are text files
          ...
          <div className="pt-4 border-0 bg-transparent invisible" />
          <p>
            Through the use of cookies, the Optify can provide the users of this
          ...
          <div className="pt-8 border-0 bg-transparent invisible" />
          <h2 className="text-2xl lg:text-3xl font-medium text-center py-4">
          ...
          <div className="pt-4 border-0 bg-transparent invisible" />
          <p>
            The website of the Optify collects a series of general data and
          ...
          <div className="pt-4 border-0 bg-transparent invisible" />
          <p>
            When using these general data and information, the Optify does not
            ...
            prosecution in case of a cyber-attack. Therefore, the Optify
          ...
          <div className="pt-4 border-0 bg-transparent invisible" />
          <p>
            The Optify offers users the possibility to leave individual comments
            on individual blog contributions on a blog, which is on the website
            of the controller. A blog is a web-based, publicly-accessible
          ...
          <ol className="list-alpha list-inside">
            ...
            <div className="pt-2 border-0 bg-transparent invisible" />
            <li>
              <p children="Right of access" className="font-bold" />
              <p>
...
If a data subject wishes to exercise this right to rectification, he or she may, at any time, contact any employee of the controller."
            ...
            <li>
              ...
              Optify, he or she may, at any time, contact any employee of the
              controller. An employee of Optify shall promptly ensure that the
              erasure request is complied with immediately. Where the controller
              has made personal data public and is obliged pursuant to Article
              17(1) to erase the personal data, the controller, taking account
              ...
              required. An employees of the Optify will arrange the necessary
              measures in individual cases.
            </li>

            <div className="pt-2 border-0 bg-transparent invisible" />
            <li>
              <p className="font-bold">Right of restriction of processing</p>
              <p>
                Each data subject shall have the right granted by the European
            ...
            <li>
              ...
              data stored by the Optify, he or she may at any time contact any
              employee of the controller. The employee of the Optify will
...
"
          ...
          <p>
            ...
            business contacts. Over 400 million registered people in more than
            200 countries use LinkedIn. Thus, LinkedIn is currently the largest
            platform for business contacts and one of the most visited websites
            in the world.
          </p>
          <div className="pt-4 border-0 bg-transparent invisible" />
          <p>
          ...
          <p>
            ...
            information to the personal LinkedIn user account of the data
            subject and stores the personal data.
          </p>
          <div className="pt-4 border-0 bg-transparent invisible" />
          <p>
            ...
            This occurs regardless of whether the person clicks on the LinkedIn
          ...
          <p>
            ...
            Nielsen, Comscore, Eloqua, and Lotame. The setting of such cookies
            may be denied under https://www.linkedin.com/legal/cookie-policy.
